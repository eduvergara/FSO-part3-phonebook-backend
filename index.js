...
// TODO: I highly suggest you start applying the MCV pattern specially for Express API(s),
// Take a look at this article, focus on the key concepts, the author describes.
// https://www.zacfukuda.com/blog/express-file-folder-structure
...
// TODO: this sort of "utility" middlewares should in a middleware directory
// As it's own function, then import and consume the function in here
// Once you read the article above it will make more sense as to why.
...
// TODO: As per the point above, those request, response callback/functions,
// I.e. "get", "post", "put", "delete", etc,
// Should be in it's own file in a "controller" directory
...
app.get('/api/persons', (request, response, next) => {
	...
	// As per the comment below at the "error handling middleware"
	// I would suggest you handle the error at the controller layer,
	// That way you can pass the custom error message, at the point
	// It keeps the code more readable and within context of what it is supposed to mean.
});
...
// TODO: Same as the comment above, this middleware should be in the middleware directory
...
// TODO: Same as the comment above, this middleware should be in the middleware directory
// TODO: Challenge for you, make this "middleware" as generic as possible,
// So that you can re use it with other " entities/models controllers",
// For example, make the error and error.name comparison values as input variables

// Also just an observation, there is many ways to handle errors,
// I would strongly suggest, error to be handled at controller layer.
// Rather than as middleware for this "particular use case".
